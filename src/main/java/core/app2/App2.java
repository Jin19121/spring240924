...
public class App2 {
    public static void main(String[] args) {
        //Spring Bean 들을 생성 (spring이 만든 인스턴스 => spring bean)
        // 생성과정: 현재 App의 패키지와 그 하위 패키지를 모두 탐색해서 @Component 가 붙은 클래스로 객체(Spring Bean)을 생성함
        ...
        //@Component 안 붙이면 만들어진 spring bean이 없음 -> exception
        //@Component 붙이면 객체 만들어짐
        //@Controller와 @Service가 @Component를 포함하여 가짐
    }
}
