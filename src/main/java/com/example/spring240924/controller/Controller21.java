...
import com.example.spring240924.controller.dto.c21.*;
...
public class Controller21 {
    ...
    //@ModelAttribute를 붙인 메소드 아규먼트(객체)는
    // request parameter가 객체의 property에 binding된다.
    @GetMapping("sub3")
    public void g3() {
    }
    ...
    @GetMapping("sub6")
    public void g6(@ModelAttribute Mybean6 a, //myBean
                   Model model) {
...
//        Object m = model.getAttribute ("book");
    ...
    @GetMapping("sub7")
    public void g7(Mybean6 a, //myBean
                   Model model) {
        System.out.println("a = " + a);
        // jsp: ${book.title}
//        Object m = model.getAttribute ("book");
    ...
    //연습: 전송버튼 클릭시 post 방식으로 sub9경로로 요청하는 코드
    @GetMapping("sub8")
    public void g8() {
    }

    //연습: model에 있는 attribute의 각 property를 출력하는 코드
    @PostMapping("sub9")
